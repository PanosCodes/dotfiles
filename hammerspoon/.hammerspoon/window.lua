...
function obj:init()
    ...
    -- Set up key bindings
    self.hs.hotkey.bind({"alt", "shift"}, "k", function() self:move_window_to_previous_desktop() end)
    self.hs.hotkey.bind({"alt", "shift"}, "j", function() self:move_window_to_next_desktop() end)
end
